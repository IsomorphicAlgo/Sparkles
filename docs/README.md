...
| File | Purpose |
|------|---------|
| **[ML_EXPANSION.md](ML_EXPANSION.md)** | Living roadmap for richer models, YAML-driven features, and preprocessing (post–Phase 1). |
| **[plan-phase2-overview.md](plan-phase2-overview.md)** | Phase 2 index: interval/live assistant (data → inference → state/UI/journal). |
