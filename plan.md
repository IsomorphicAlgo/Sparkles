...
| 2026-06-21 | **ML expansion Phase G2 complete (owner approved):** session time, volume context, VWAP distance feature groups; preset **`rklb_daytrade_g1_g2_v1.yaml`**. | `sparkles/features/session.py`, `sparkles/config/schema.py`, `sparkles/features/registry.py`, `sparkles/features/dataset.py`, `configs/experiments/presets/rklb_daytrade_g1_g2_v1.yaml`, `tests/test_session_features.py`, `DEVELOPER.md`, `docs/ML_EXPANSION.md`, `plan.md` | **Post–Phase 1** (ML expansion G2) |
